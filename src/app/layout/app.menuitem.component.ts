...
@Component({
    ...
    template: `
		<ng-container *ngIf="!(item.label=='New ArtWorks') || authService.roles.includes('ADMIN')">
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public layoutService: LayoutService, private cd: ChangeDetectorRef, public router: Router, private menuService: MenuService, public  authService : AuthService) {
